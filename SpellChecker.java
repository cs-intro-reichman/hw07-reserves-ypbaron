...
public class SpellChecker {
	...
	public static int levenshtein(String word1, String word2) {
		...
		String tail1 = tail(lowerWord1);// calls tails
		String tail2 = tail(lowerWord2);// calls tails
		...
		if (lowerWord1.charAt(0) == word2.charAt(0)){
			return levenshtein(tail1, tail2);
		}
		return 1 + Math.min(levenshtein(tail1, lowerWord2), Math.min(levenshtein(lowerWord1, tail2), levenshtein(tail1, tail2)));	// go over
	}		
